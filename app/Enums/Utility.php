...
final class Utility
{
    ...
    {
        if ($input) {
            $status = Storage::disk('public-image-group')->put($input['image']->getClientOriginalName(), $input['image']->get());
            return $status;
        }
    }
    ...
    {
        if ($input) {
            $status = Storage::disk('public-image-user')->put($input['avatar']->getClientOriginalName(), $input['avatar']->get());
            return $status;
        }
    }
