...
class LeagueRepository extends BaseRepository
{
    ...
    public function index($user)
    {
        ...
        return $this->model->where('owner_id', $user)->orderBy('created_at', 'desc')->get();
    }
    ...
    {
        return $this->model->where('status', 1)->orderBy('created_at', 'desc')->take(2)->get();
    }
...
// filter league at League tab
    ...
    {
        return $this->model->with(['userLeagues' => function($query) {
